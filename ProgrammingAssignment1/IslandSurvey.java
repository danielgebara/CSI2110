...
public class IslandSurvey {
    public static void main(String[] args) {
        ...
        for (int phase = 0; phase < F; phase++) {
            ...
            // Survey the land after flood recovery
            surveyLand(partition);
        }
    ...
    // Function to display the Survey of the Land
    private static void surveyLand(Partition<int[]> partition) {
